 ...
 */
class ST_Widget_Staff extends ST_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'ascend_staff';
		$this->widget_name        = __( 'ST: Ascend Staff', 'suffice-toolkit' );
	...
	public function widget( $args, $instance ) {
		...
		suffice_get_template( 'content-widget-staff.php', array( 'instance' => $instance ) );
