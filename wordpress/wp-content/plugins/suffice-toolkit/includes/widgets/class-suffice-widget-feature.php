 ...
 */
class ST_Widget_Feature extends ST_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'themegrill_suffice_feature';
		$this->widget_name        = __( 'ST: Feature Project', 'suffice-toolkit' );
	...
	public function widget( $args, $instance ) {
		...
		suffice_get_template( 'content-widget-feature.php', array( 'instance' => $instance ) );
