 ...
 */
class ST_Widget_Feature_Hot extends ST_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Add your feature here.', 'suffice-toolkit' );
		$this->widget_id          = 'themegrill_suffice_feature_hot';
		$this->widget_name        = __( 'ST: Hot Project', 'suffice-toolkit' );
		...
		$this->settings           = apply_filters( 'suffice_toolkit_widget_settings_' . $this->widget_id, array(
			...
			'column' => array(
				...
				'options' => array(
					'1' => __( '1 Column', 'suffice-toolkit' ),
					'2' => __( '2 Column', 'suffice-toolkit' ),
				),
				'group'   => __( 'General', 'suffice-toolkit' ),
			),
			'style' => array(
	...
	public function widget( $args, $instance ) {
		...
		suffice_get_template( 'content-widget-feature-hot.php', array( 'instance' => $instance ) );
