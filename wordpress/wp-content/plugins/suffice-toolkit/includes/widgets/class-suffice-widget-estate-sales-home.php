 ...
 */
class ST_Widget_Estate_Sale_Home extends ST_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'ST: Home Estate Sale', 'suffice-toolkit' );
	...
	public function widget( $args, $instance ) {
		...
		suffice_get_template( 'content-widget-estate-sales-home.php', array( 'instance' => $instance ) );
